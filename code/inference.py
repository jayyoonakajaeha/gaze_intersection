...
def draw_result(image_path, eye, heatmap, gaze_point,k,i):
    x1, y1 = eye
    x2, y2 = gaze_point
    ...
    cv2.imwrite(f'./results/tmp_{k}_{i}.png', img)
...
def main():
    ...
    cnt=0
    for k in range(150):
        test_image_path = f'../../imgs/frame_{k:05d}.png'
        input_path = f'../../../openpose-1.7.0-binaries-win64-gpu-python3.7-flir-3d_recommended/openpose/output/3_{k:012d}_keypoints.json'
        print(input_path)
        ...
        for i,people in enumerate(coor):
            ...
            draw_result(test_image_path, (x, y), heatmap, (p_x, p_y),k,i)
            f.write(f'person {i}\n{p_x} {p_y}\n')
